...
// Iconos como componentes - evita re-renderizado de SVG
const LocationIcon = () => (
...
const ContactSection = () => {
  ...
  return (
    ...
    >
      ...
      {/* Decorative elements - sin animaciones */}
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">
            ...
            <div className="group relative">
              {/* Glow effect - SOLO opacity, sin willChange */}
              <div className="absolute -inset-0.5 bg-gradient-to-r from-emerald-500 to-emerald-400 rounded-2xl blur opacity-30 group-hover:opacity-50 transition-opacity duration-500" />
                ...
                <div className="mt-6 p-4 rounded-xl border bg-gray-100/50 dark:bg-gray-800/50 border-gray-200/30 dark:border-gray-700/30">
                  ...
                  <div className="flex items-center justify-between text-sm mt-2">
                    ...
                    <div className="flex items-center gap-2">
                      {/* Pulse con CSS puro - más eficiente */}
            ...
            <div className="group relative">
              {/* Glow effect - SOLO opacity, sin willChange */}
              <div className="absolute -inset-0.5 bg-gradient-to-r from-emerald-400 to-emerald-500 rounded-2xl blur opacity-30 group-hover:opacity-50 transition-opacity duration-500" />
      ...
      {/* CSS puro para pulse - más eficiente que Tailwind animate-pulse */}
      <style jsx>{`
        @keyframes pulse-dot {
          0%, 100% { opacity: 1; }
          50% { opacity: 0.5; }
