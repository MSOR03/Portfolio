  ...
  return (
    <header className="sticky top-4 z-50">
      <div
        ...
        `}
      >
        {/* Efecto de brillo de fondo dinámico */}
        <div 
        ...
        {/* Desktop nav - AQUÍ ESTÁ LA INTEGRACIÓN DEL THEME TOGGLE */}
        <div className="hidden lg:flex items-center gap-6 text-sm font-medium relative z-10">
          <Nav />
        ...
        {/* Mobile nav - TAMBIÉN AGREGAMOS EL THEME TOGGLE PARA MÓVIL */}
